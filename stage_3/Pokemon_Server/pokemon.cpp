...
QList<uint> Pokemon::getUpdateInfo()
{
    QList<uint> info;
    info.append (this->level);
    info.append (this->experience);
    info.append (this->attack);
    info.append (this->blood);
    info.append (this->defense);
    info.append (this->speed);
...
UDPPkm* Pokemon::getAttr()
{
    ...
    attr->currentBlood=this->currentBlood;
